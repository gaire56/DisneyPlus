  ...
  return (
    <Container>
      ...
      <Description>
        ...
        molestias, officiis rem temporibus magni hic facilis perferendis
        repellendus quas atque rerum fuga et consequuntur voluptas quis odit.
        Fugit, autem.
      </Description>
    </Container>
  );
...
const TraillerButton = styled(PlayButton)`
  ...
  border: 1px silid rgb(249, 249.249);
